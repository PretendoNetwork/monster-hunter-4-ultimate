...
func init() {
	...
	kerberosPassword := os.Getenv("PN_MH4U_KERBEROS_PASSWORD")
	...
	if strings.TrimSpace(kerberosPassword) == "" {
		globals.Logger.Warningf("PN_MH4U_KERBEROS_PASSWORD environment variable not set. Using default password: %q", globals.KerberosPassword)
	} else {
